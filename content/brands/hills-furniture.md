...
intro_body: "Hills Furniture is a British maker that has been building solid-hardwood dining and bedroom furniture for decades. The pieces are heavier than the flat-pack alternatives, the joinery is honest, and the finishes hold up to the kind of wear a country kitchen actually puts a table through. We stock Hills because the construction outlasts the cheaper end of the market by years."

what_we_stock_h2: "Hills at Canwell"
what_we_stock_body: |
  We carry a rotating selection from Hills' range: predominantly dining tables, chairs, sideboards, and bedroom furniture in oak and other British hardwoods.
...
why_body: |
  ...
  These are pieces that should last decades. Worth half an hour in the showroom before committing.

cta_eyebrow: "Ready"
cta_h2: "Visit to see the *Hills range*."
ctas:
  - { label: "Visit to see the Hills range", url: "/visit", variant: "primary" }
  - { label: "Book a design consultation", url: "/design-help/in-store-consultation", variant: "secondary" }
  - { label: "Call to ask about stock", url: "tel:01905964994", variant: "tertiary" }
---
