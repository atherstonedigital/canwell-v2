...
why_body: |
  ...
  Coming in also means we can compare two Richmond pieces side-by-side, hold the fabric next to your carpet sample, and talk through which of their collections suits the room you're working on.

cta_eyebrow: "Ready"
cta_h2: "Visit to see the *Richmond range*."
ctas:
  - { label: "Visit to see the Richmond range", url: "/visit", variant: "primary" }
  - { label: "Book a design consultation", url: "/design-help/in-store-consultation", variant: "secondary" }
  - { label: "Call to ask about a specific piece", url: "tel:01905964994", variant: "tertiary" }
---
