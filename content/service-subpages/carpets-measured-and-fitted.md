...
intro_body: |
  We give one quote, all in. It covers the carpet itself, the underlay, the grippers, the door bars and thresholds, the fitting, the removal of your old carpet, and moving furniture in and out of the room. No top-ups, no extras invoiced afterwards.

  The only things we add separately are very heavy or fitted items (pianos, fitted wardrobes, hot tubs). Most jobs don't need them.

steps_h2: "How a fitted carpet job runs"
steps:
...
faqs:
  ...
  - question: "Do you take away the old carpet?"
    answer: "Yes, included."
  - question: "Can I bring my own carpet?"
    answer: "We don't fit third-party carpet. Our fitters work with our suppliers and we can't guarantee a job we haven't supplied the materials for."
  ...
  - question: "Sloping floors in an old Cotswold cottage?"
    answer: "Often. Older buildings need a more experienced fitter and sometimes a different underlay choice. We sort that."
  - question: "Do you do hallways and landings as one continuous run?"
    answer: "Where the floor layout allows, yes. We'll discuss where joins are needed on the day of the measure."

cta_eyebrow: "Ready"
cta_h2: "Book the *measure*."
ctas:
  - { label: "Book a free home measure", url: "/design-help/home-visit", variant: "primary" }
  - { label: "Visit to see the samples", url: "/visit", variant: "secondary" }
